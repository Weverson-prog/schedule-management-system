...
<div class="single">
	<div class="container">
		...
		<p style="color:black; font-size:30px; font-family:arial;font-weight: bold;">Horário foi marcado com sucesso!</p>
			...
			<input style="width: 180px;height: 40px; font-size:20px ;border-radius:15px;margin-top: 5px;margin: auto;line-height: 0;" type="submit" value="Calendário" onclick="location.href='controleAgenda'">
