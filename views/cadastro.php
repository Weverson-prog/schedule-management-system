<?php \Classes\ClassLayoutCadastro::setHead('Cadastro','Realize seu cadastro em nosso sistema.'); ?>
...
<form name="formCadastro" id="formCadastro"  action="<?php echo DIRPAGE.'controllers/controllerCadastro'; ?>" method="post">
    <div class="cadastro float center">
        ...
        <input class="float w100 h40" type="text" id="nome" name="nome" placeholder="Nome:" maxlength="42" required >
