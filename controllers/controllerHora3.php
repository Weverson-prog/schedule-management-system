                     ...
                     //echo 'dia atual '.$dia_atual.'<br/>';
					    ...
					    $ano = $_GET['ano'];
                         ...
                         echo "<div id='box_hr'>";
                             ...
                             echo "<b style='font-size: 19px;color: black'>Escolha um horario para ".$dia_semana." Dia ".$dia."<br>";
					 ...
					 $rows_dia = $result_dia->fetchAll();
                         ...
                         foreach ($rows_horarios as $key => $value){
	                         $hora_disp = $value['hora_disp'];
	                          ...
	                          if(($hora_atual<=$hora_disp)){
	                               echo '<b style=color:black;>'.$hora_disp.'<br/><input type="submit" onclick="location.href=\'cadastroHr2?id_user='.$id_cliente.'&&dia_dia='.$dia.'&&mes_mes='.$mes.'&&ano_ano='.$ano.'&&hora_disp='.$hora_disp.'\'" value="Marcar" style="width: 170px;height: 30px;border-radius:15px;margin-top: 5px;margin: auto;line-height: 0; font-size: 25px"/><br/>';
	                           }else{}
                     ...
                     $conta_horarios = sizeof($rows_horarios);
                                       ...
                                       foreach ($rows_horarios as $key => $value){
	                                    $hora_disp = $value['hora_disp'];
	                                           ...
	                                           //echo $hora_disp.'<br/>';
											   echo '<b style=color:black;>'.$hora_disp.'<br/><input type="submit" onclick="location.href=\'cadastroHr2?id_user='.$id_cliente.'&&dia_dia='.$dia.'&&mes_mes='.$mes.'&&ano_ano='.$ano.'&&hora_disp='.$hora_disp.'\'" value="Marcar"  style="width: 170px;height: 30px;border-radius:15px;margin-top: 5px;margin: auto;font-size: 25px;line-height: 0;"/><br/>';
